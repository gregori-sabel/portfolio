...
import { Component, Header, Footer, Text, Content } from './styles';
import { FiMessageCircle } from  'react-icons/fi'
import Icon from '../TwitterIcons';
...
export function Post({ text, title, link, isGithub = false, index }: Props) {
